          ...
          <>
            ...
            {!dropoff ? (
              ...
              <>
                ...
                {readiness.compliance_gate && <div className="mt-4 rounded-2xl border border-emerald-100 bg-emerald-50 p-4"><div className="flex items-center gap-2 font-black text-emerald-950"><ShieldCheck size={18} />{serviceLabel} booking is opening soon</div><p className="mt-1 text-xs leading-5 text-emerald-900">We're activating verified Zeshu partners for this area. You can choose your pickup and destination now, and live booking will open as soon as this service is ready near you.</p></div>}
