    ...
    <main className="min-h-screen bg-[#f7f9f5] px-4 py-8 text-slate-900 md:px-8 md:py-14">
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-6 overflow-hidden rounded-[32px] bg-[#083b27] p-6 text-white md:p-10">
          <p className="text-xs font-black uppercase tracking-[.18em] text-[#a6dfba]">Get Zeshu</p>
          <h1 className="mt-2 max-w-3xl text-3xl font-black tracking-tight md:text-5xl">Put Zeshu on your home screen.</h1>
          <p className="mt-4 max-w-2xl text-sm leading-6 text-[#d9f3e3]">Install the Zeshu web app today for faster access. Jagtial physical delivery and India-wide digital services stay available from the same account.</p>
        </section>
        ...
        <section className="mt-6 grid gap-5 md:grid-cols-[1fr_320px]">
          <div className="rounded-[28px] border border-emerald-100 bg-white p-6 shadow-sm md:p-8">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-2xl bg-emerald-50 p-4"><p className="text-xs font-black uppercase tracking-wider text-[#087443]">All India</p><p className="mt-1 font-black">Digital services</p><p className="mt-1 text-xs leading-5 text-slate-600">Recharge, bills, QR tools, rewards and sponsored digital offers can serve users nationwide as each provider is enabled.</p></div>
            </div>
          </div>

          <aside className="rounded-[28px] border border-slate-200 bg-white p-6 text-center shadow-sm">
            <p className="text-xs font-black uppercase tracking-[.16em] text-slate-500">Open on another phone</p>
            ...
            <p className="mt-4 text-sm font-black">Scan to open zeshu.in/app</p>
            <p className="mt-1 text-xs leading-5 text-slate-500">When the native Android app is released, this same page can hand users to Google Play without changing printed QR codes.</p>
          </aside>
        </section>
      </div>
    </main>
