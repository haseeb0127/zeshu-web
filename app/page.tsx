        ...
        <>
          ...
          <div role="dialog" aria-modal="true" aria-labelledby="account-title" className="fixed top-0 right-0 h-full w-full md:w-[460px] bg-[#F8F9FC] z-[70] shadow-2xl animate-in slide-in-from-right duration-500 flex flex-col md:rounded-l-[32px] overflow-hidden">
            ...
            <div className="flex flex-1 flex-col overflow-y-auto p-6 space-y-6">
              <section className="order-3 rounded-[24px] border border-slate-200 bg-white p-5" aria-labelledby="saved-addresses-title">
              ...
              <section className="order-4 rounded-[24px] border border-emerald-100 bg-white p-5" aria-labelledby="invite-earn-title">
              ...
              <div className="order-0 bg-gradient-to-br from-[#4F46E5] to-[#4338CA] p-6 rounded-[24px] text-white shadow-lg">
              ...
              <section className="order-2 rounded-[24px] border border-slate-200 bg-white p-5">
