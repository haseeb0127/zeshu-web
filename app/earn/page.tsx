...
const roles = [
  ...
  { title: "Bike Courier", body: "Documents and small parcels after courier operations are approved.", icon: <Package size={22} /> },
  { title: "Auto Driver", body: "Passenger rides only after the applicable transport and aggregator requirements are cleared.", icon: <Car size={22} /> },
  { title: "Cab / Car Driver", body: "Local, rental and outstation rides through an approved mobility model.", icon: <Car size={22} /> },
    ...
    <main className="min-h-screen bg-[#f6faf7] px-4 py-6 text-slate-900 md:px-8 md:py-10">
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-7">
          <h2 className="mb-3 text-xl font-black">{t("Register your interest")}</h2>
