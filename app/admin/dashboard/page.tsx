    ...
    <main className="mx-auto max-w-7xl p-5">
      ...
      {tab === "support" && <section className="grid gap-5 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        <div className="rounded-2xl bg-white p-5 shadow-[0_4px_16px_rgba(19,32,25,.06)]">
          <div className="flex flex-wrap items-center justify-between gap-3"><div><h2 className="text-lg font-black">Support inbox</h2><p className="mt-1 text-xs text-slate-500">Safety first, then payment/refund/provider disputes, then routine customer questions.</p></div><button type="button" onClick={() => void loadSupportConversations()} className="rounded-xl bg-slate-100 px-3 py-2 text-xs font-black">Refresh</button></div>
